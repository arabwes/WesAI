/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7b8f13ccd920507532c3178b66bd5315)
// Runtime types generated with workerd@1.20260903.1 2026-09-03 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	TOAST_RESULTS: R2Bucket;
	TOAST_MCP_DB: D1Database;
	CAFE_MCP_JOBS: Queue;
	ASSETS: Fetcher;
	APP_ENV: "staging" | "production";
	PUBLIC_ORIGIN: "https://cafe-mcp-staging.yemenicoffeeco.workers.dev" | "https://shibamatlanta.com";
	BASE_PATH: "/toast-mcp";
	AUTH0_DOMAIN: "dev-3myhg8cj7id1l4n0.us.auth0.com";
	AUTH0_CLIENT_ID: "VfnqrCMpMHqZMXObCsXFPkZhwYK7Y4cc";
	AUTH0_SCOPE: "openid profile email";
	TOAST_PARTNER_MODE: "disabled";
	TOAST_BYO_MODE: "disabled";
	TOAST_PARTNER_ENVIRONMENT: "sandbox" | "production";
	...
	CAFE_CREDENTIAL_BROKER: DurableObjectNamespace<import("./src/index").CafeCredentialBroker>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CafeCredentialBroker";
	}
	interface StagingEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "staging";
		PUBLIC_ORIGIN: "https://cafe-mcp-staging.yemenicoffeeco.workers.dev";
		BASE_PATH: "/toast-mcp";
		AUTH0_DOMAIN: "dev-3myhg8cj7id1l4n0.us.auth0.com";
		AUTH0_CLIENT_ID: "VfnqrCMpMHqZMXObCsXFPkZhwYK7Y4cc";
		AUTH0_SCOPE: "openid profile email";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "PUBLIC_ORIGIN" | "BASE_PATH" | "AUTH0_DOMAIN" | "AUTH0_CLIENT_ID" | "AUTH0_SCOPE" | "TOAST_PARTNER_MODE" | "TOAST_BYO_MODE" | "TOAST_PARTNER_ENVIRONMENT" | "EMAIL_FROM" | "SESSION_TTL_SECONDS" | "AUDIT_RETENTION_DAYS" | "RESULT_TTL_SECONDS" | "INLINE_RESULT_MAX_BYTES" | "RESULT_CHUNK_MAX_BYTES">> {}
}
