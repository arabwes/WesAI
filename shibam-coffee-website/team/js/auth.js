...
(function () {
  ...
  function errorMessage(result, fallback) {
    var messages = {
      ...
      write_up_not_found: 'That employee message could not be found.',
      write_up_not_editable: 'This write-up has already been sent and can no longer be edited.',
      write_up_already_sent: 'This write-up has already been sent.',
      write_up_not_awaiting_response: 'This message is no longer waiting for a response.',
